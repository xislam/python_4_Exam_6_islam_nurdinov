...
class (models.Model):
    ...
    creation_date = models.DateField(max_length=3000, null=True, blank=True, verbose_name='Дата_создания')
    change_date = models.DateField(max_length=3000, null=True, blank=True, verbose_name='Дата_изменения')
